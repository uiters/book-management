...
const PaginationSearchPublisherPage = (datas: PaginationModel) => {
                    ...
                    <table className='border-collapse border border-blue-800 -mt-3 p-3 justify-center'>
                        ...
                        <tbody>
                            {slicedData.map((item: any) => (
                                <tr key={item.id}>
                                    <td className="border border-blue-600 w-11/12">{item.name}</td>
...
export default PaginationSearchPublisherPage;